...
public class DiscordConfig {
    ...
    // private boolean enableConsoleLog = false; // Removed
    ...
    public String getBotActivityType() {
        return botActivityType;
    }

    public String getBotActivityText() {
        return botActivityText;
    }
    ...
    public int getMaxAccountsPerDiscord() {
        return maxAccountsPerDiscord;
    }
    ...
    public String getStatusChannelId() {
        return statusChannelId != null && !statusChannelId.isEmpty() ? statusChannelId : chatChannelId;
    }
    ...
    public boolean isSyncBansDiscordToMc() {
        return syncBansDiscordToMc;
    }

    public boolean isSyncBansMcToDiscord() {
        return syncBansMcToDiscord;
    }
    ...
    public boolean isTranslateEmojis() {
        return translateEmojis;
    }
    ...
    public boolean isEnableTopicUpdate() {
        return enableTopicUpdate;
    }

    public String getChannelTopicFormat() {
        return channelTopicFormat;
    }
    ...
    public String getInvalidCodeMessage() {
        return invalidCodeMessage != null ? invalidCodeMessage : "Invalid or expired code.";
    }

    public String getNotLinkedMessage() {
        return notLinkedMessage != null ? notLinkedMessage : "You are not linked to any account.";
    }

    public String getAlreadyLinkedSingleMessage() {
        return alreadyLinkedSingleMessage != null ? alreadyLinkedSingleMessage : " you are already linked!";
    }

    public String getAlreadyLinkedMultipleMessage() {
        return alreadyLinkedMultipleMessage != null ? alreadyLinkedMultipleMessage
                : " you are already linked to multiple accounts.";
    }

    public String getUnlinkSuccessMessage() {
        return unlinkSuccessMessage != null ? unlinkSuccessMessage : "Successfully unlinked all accounts.";
    }

    public String getWrongGuildMessage() {
        return wrongGuildMessage != null ? wrongGuildMessage
                : "This command can only be used in the configured server.";
    }

    public String getTicketCreatedMessage() {
        return ticketCreatedMessage != null ? ticketCreatedMessage : "Ticket created!";
    }

    public String getTicketClosingMessage() {
        return ticketClosingMessage != null ? ticketClosingMessage : "Closing ticket...";
    }

    public String getTextChannelOnlyMessage() {
        return textChannelOnlyMessage != null ? textChannelOnlyMessage
                : "This command can only be used in a text channel.";
    }

    // public boolean isEnableConsoleLog() { return enableConsoleLog; } // Removed
    public boolean isEnableStatusMessages() {
        return enableStatusMessages;
    }

    public String getStatusMessageStarting() {
        return statusMessageStarting;
    }

    public String getStatusMessageStarted() {
        return statusMessageStarted;
    }

    public String getStatusMessageStopping() {
        return statusMessageStopping;
    }

    public String getStatusMessageStopped() {
    ...
    public void setChannelTopicFormat(String channelTopicFormat) {
        this.channelTopicFormat = channelTopicFormat;
    }
