# Voidium Release Notes: v1.3.4 → v2.0.0

Complete changelog from the last public release (v1.3.4) to the latest version (v2.0.0).
...
## [1.3.4] - 2025-11-20 (Last Public Release)
...
## 📊 Summary of Changes (v1.3.4 → v2.0.0)
